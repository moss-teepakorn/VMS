...
export default function AdminDisbursementsSetup() {
    ...
    <div className="pane on houses-compact fees-compact payments-setup-compact">
      <div className="ph houses-ph">
        <div className="ph-in">
          <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
            ...
            <div>
              <div className="ph-h1">ตั้งค่ารายการจ่ายเงิน</div>
              <div className="ph-sub">จัดการรายการประเภทจ่ายเงินและคู่ค้านิติบุคคล</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="card houses-main-card">
        <div className="ch houses-list-head houses-main-head">
          <div className="ct">รายการประเภทจ่ายเงิน</div>
        ...
        <div className="house-mo">
          <div className="house-md house-md--sm" style={{ height: 'auto', maxHeight: 'min(560px, 88vh)' }}>
            <div className="house-md-head">
              <div>
                <div className="house-md-title">{itemMode === 'edit' ? 'แก้ไขรายการจ่ายเงิน' : 'เพิ่มรายการจ่ายเงิน'}</div>
                <div className="house-md-sub">กรอกข้อมูลรายการประเภทจ่ายเงิน</div>
              </div>
            </div>
          ...
          <div className="house-md house-md--sm" style={{ height: 'auto', maxHeight: 'min(560px, 88vh)' }}>
            <div className="house-md-head">
              <div>
                ...
                <div className="house-md-sub">ใช้สำหรับผู้รับเงินประเภทบุคคลภายนอก</div>
              </div>
            </div>
            <div className="house-md-body" style={{ overflowY: 'auto' }}>
              <section className="house-sec">
