              ...
              <tbody>
                {loading ? (
                  ...
                  <tr key={row.id}>
                    ...
                    <td style={{ whiteSpace: 'nowrap' }}>
                      <div style={{ display: 'inline-flex', alignItems: 'center', gap: 8, flexWrap: 'wrap' }}>
                        <button className="vms-ra-btn" onClick={() => openEditPartnerModal(row)} title="แก้ไข">
                        ...
                        <button className="vms-ra-btn vms-ra-del" onClick={() => handleDeletePartner(row.id)} title="ลบ">
