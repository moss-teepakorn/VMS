      ...
      <div className="card">
        <div className="ch houses-list-head houses-main-head">
          ...
          <div className="houses-list-actions">
            <select data-search-filter="true" className="fs" value={statusFilter} onChange={(e) => { setStatusFilter(e.target.value); setSelectedUserIds([]) }} style={{ minWidth: 150, height: 34 }}>
              ...
              <div className="house-md-body">
                <section className="house-sec">
                  ...
                  <div className="house-grid house-grid-2">
                    <label className="house-field">
                      ...
                      <select data-search-filter="true" name="house_id" value={form.house_id} onChange={handleSelectHouse}>
                ...
                <section className="house-sec">
                  ...
                  <div className="house-grid house-grid-2">
                    ...
                    <label className="house-field">
                      <span>บทบาท</span>
                      <select data-search-filter="true" name="role" value={form.role} onChange={handleChange}>
                    ...
                    <label className="house-field house-field-span-2">
                      <span>สถานะ</span>
                      <select data-search-filter="true" name="is_active" value={String(form.is_active)} onChange={handleChange}>
